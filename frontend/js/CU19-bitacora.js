...
//   LOGIN, LOGOUT, CREAR_RESERVA, EDITAR_RESERVA, CANCELAR_RESERVA.
//
// PREREQUISITO: ejecutar sql/crear_bitacora.sql en la BD antes de usar.
// =============================================================================
...
// Carga y muestra todos los eventos de la bitácora desde la BD
async function cargarBitacoraAdmin() {
    ...
    try {
        ...
        if (!data.success) {
            tbody.innerHTML = '<tr><td colspan="5" style="text-align:center;color:#e74c3c;padding:20px;">Error al cargar la bitácora. Verifica que la tabla exista (ejecutar sql/crear_bitacora.sql).</td></tr>';
            return;
        }
