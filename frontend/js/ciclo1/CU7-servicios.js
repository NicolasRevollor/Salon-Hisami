// =============================================================================
// CU7-servicios.js — CRUD DE SERVICIOS (panel administrador)
// Ciclo 1 — Gestión de catálogo de servicios
// Permite al admin ver, crear, editar y marcar como inactivos los servicios.
...
//             ciclo2/CU11-personal.js (cargarCategoriasEnSelect — función compartida)
// =============================================================================
...
// Abre el modal en modo CREAR (idServicio=null) o EDITAR (con id).
// En modo edición, rellena el formulario con los datos actuales del servicio.
...
async function manejarGuardarServicio(e) {
    ...
    try {
        // Si hay id → editar (PUT), si no → crear (POST)
...
// Pide confirmación y luego marca el servicio como Inactivo (soft delete).
// No se borra físicamente para preservar el historial de reservas ya realizadas.
